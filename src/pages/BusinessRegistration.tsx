...
const BusinessRegistration = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const sanitizedData = {
        business_ref: '', // Will be auto-generated by trigger
        business_name: sanitizeHtml(formData.businessName),
        owner_name: sanitizeHtml(formData.ownerName),
        email: formData.email,
        phone: formData.phone,
        industry_type: sanitizeHtml(formData.industryType),
        full_address: sanitizeHtml(formData.fullAddress),
        gstn_number: formData.gstnNumber ? sanitizeHtml(formData.gstnNumber) : null,
        subscription_plan: planType as 'monthly' | 'yearly',
        subscription_status: 'active' as const
      };

      // Insert business record (business_ref will be auto-generated by trigger)
      ...
      setBusinessRef(businessData.business_ref);
      setIsSuccess(true);
      
      toast({
        title: "Business Registered Successfully!",
        description: `Your business reference number is ${businessData.business_ref}`,
      });
