-- Fix sales invoice processing: ensure created_by uses session user to satisfy FK and mirror adjustment logic
    ...
    BEGIN
        ...
        LOOP
            ...
            PERFORM public.record_inventory_transaction(
                ...
                NULL -- created_by: use session user (auth.uid()) like adjustments logic
            );
