...
-- Recreate the generate_user_ref function to work with companies table
...
-- Recreate the auto_generate_user_ref trigger function
...
CREATE TRIGGER trigger_auto_user_ref
    ...
    FOR EACH ROW EXECUTE FUNCTION public.auto_generate_user_ref();
