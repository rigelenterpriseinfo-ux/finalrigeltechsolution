-- Fix suppliers table - drop the constraint and recreate it scoped to company
ALTER TABLE public.suppliers DROP CONSTRAINT IF EXISTS suppliers_supplier_ref_unique;
